...
mod tests {
    ...
    fn test_pre_sign_verify() {
        ...
        // Feed a bitcoin transaction here -- 300 to 400 bytes 


        let msg = b"it's not about the money, it's about sending a message it's not about the money, it's not about the money, it's about sending a message it's not about the money it's not about the money, it's about sending a message it's not about the moneyit's about sending a message it's not about the money, it's about sending a message it's not about the money, it's about sending a message it's not about the money, it's about sending a message";
        ...
        use crate::schnorr::tests::std::println;
